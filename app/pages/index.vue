    ...
    <section
      ...
      <div
        ...
        <div class="md:w-1/2 space-y-6">
          ...
          <div
            v-if="profile"
            class="pt-2 animate-fade-in-up flex justify-center md:justify-start"
            ...
            <a
              :href="`https://wa.me/${formatPhoneForWhatsapp(
                ...
                profile.nama
              }, saya tertarik dengan promo motor Yamaha.`"
              target="_blank"
              class="inline-flex items-center gap-3 px-6 py-3 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/30 rounded-xl transition-all group">
              <div
                class="w-10 h-10 rounded-full border-2 border-white overflow-hidden shrink-0">
                <img
                  :src="profile.photo"
                  class="w-full h-full object-cover"
                  :alt="profile.nama" />
              ...
              <div class="text-left">
                <p class="text-xs text-gray-300">Butuh Bantuan?</p>
                <p
                  class="flex gap-2 text-sm font-bold text-white group-hover:text-red-400 transition-colors">
                  <svg
