    ...
    <div class="bg-gray-900 text-white py-20 px-4 mb-12">
      <div class="container mx-auto text-center">
        ...
        <p class="text-gray-400 max-w-2xl mx-auto text-lg">
          Jangan lewatkan promo spesial dan penawaran terbaik bulan ini.
        </p>
      </div>
    </div>
    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div
          ...
          <img
            ...
            :alt="item.description || 'Promo Yamaha'"
          ...
          <div :id="`gallery-hidden-${index}`" class="hidden">
            <img
              ...
              :key="imgIdx"
              :src="img"
              :alt="`${item.description || 'Promo'} - Halaman ${imgIdx + 1}`" />
          </div>
        </div>
      </div>
      ...
      <div v-if="loading" class="py-20 text-center">
        <div class="animate-pulse flex flex-col items-center">
          ...
          <p class="text-gray-400">Memuat data promo...</p>
        </div>
      </div>

      <div
        v-else-if="promoList.length === 0"
...
useHead({
  title: "Info Promo | Yamaha Deta Denpasar",
});

const { getPromoList } = usePromo();
